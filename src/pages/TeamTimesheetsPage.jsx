...
export default function TeamTimesheetsPage() {
  ...
  return (
    ...
    <main className="flex flex-col h-[calc(100dvh-3.5rem-env(safe-area-inset-top)-env(safe-area-inset-bottom))] sm:h-[calc(100dvh-4rem-env(safe-area-inset-top)-env(safe-area-inset-bottom))]">
