...
export default function TeamTimesheetsPage() {
  ...
  return (
    ...
    <main className="flex flex-col h-[calc(100dvh-3.5rem-var(--top-inset)-env(safe-area-inset-bottom))] sm:h-[calc(100dvh-4rem-var(--top-inset)-env(safe-area-inset-bottom))]">
