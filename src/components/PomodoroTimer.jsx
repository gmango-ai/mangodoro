...
import { X, RotateCcw, PictureInPicture2, ChevronDown, ChevronUp, Users, LogOut, Copy, Pencil, Check, Link as LinkIcon, Lock, Unlock, Clock } from "lucide-react";
...
function MeetingCountdown({ expiresAt, sessionId, dark }) {
  ...
  // Urgency tint when <60s remain so people notice the room is about
  // to close.
