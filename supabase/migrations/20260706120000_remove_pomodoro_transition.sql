-- Remove the 5-second Pomodoro transition.
--
-- Keep resolving existing pending_mode rows for compatibility, but stop
-- producing new pending transitions when a work phase completes.
